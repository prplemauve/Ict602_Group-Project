...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull RelativeLayout rootView, @NonNull MaterialButton btnLogin,
      @NonNull EditText edLoginEmail, @NonNull EditText edLoginPassword,
      @NonNull TextView forgotpass, @NonNull TextView signin, @NonNull Button signupButton) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((RelativeLayout) rootView, btnLogin, edLoginEmail,
          edLoginPassword, forgotpass, signin, signupButton);
    }
